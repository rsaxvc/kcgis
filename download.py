...
def do_stuff(q):
	while True:
		...
		if( not os.path.isfile(outpath) ):
			...
			item = "https://mapd.kcmo.org/kcgis/rest/services/CachedMaps/Orthophoto_2022/MapServer/tile/10/"+str(x)+"/"+str(y)
			try:
...
tiles = []
for x in range(83309,84183):
	for y in range(82656,83177):
		tiles.append( (x,y) )
